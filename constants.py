...
CITYSCAPES_MAP_INVERTED = {}

for cat in CITYSCAPES_MAP:
    for cat_id in CITYSCAPES_MAP[cat]:
        CITYSCAPES_MAP_INVERTED[cat_id] = cat

COCO_PANOPTIC_JSON = json.loads(
    """[
    {
...
COCO_PANOPTIC_COLOR: Dict[int, str] = {}
COCO_PANOPTIC_SUPERCATEGORY_COLOR: Dict[int, str] = {}
COCO_PANOPTIC_NAME_COLOR: Dict[int, str] = {}

for item in COCO_PANOPTIC_JSON:
    class_id = item["id"] - 1
    class_supercategory = item["supercategory"]
    class_name = item["name"]
    class_color = item["color"]

    # assert COCO_PANOPTIC_COLOR not in list(COCO_PANOPTIC_COLOR.keys())

    COCO_PANOPTIC_COLOR[class_id] = class_color
    COCO_PANOPTIC_SUPERCATEGORY_COLOR[class_id] = class_supercategory
    COCO_PANOPTIC_NAME_COLOR[class_id] = class_name
